    ...
    const audioWithUrls = audioEntries.map(entry => {
      ...
      const mapAudioData = (audios) => {
        return audios.map(item => {
          return {
            id: item.id,
            title: item.title,
            audio: "https://audio-uploadss.blr1.digitaloceanspaces.com/audio-uploads/" + extractFileName(item.audio),
      ...
      return {
        ...
        ru: {
          ...
          smallaudio: "https://audio-uploadss.blr1.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.ru.smallaudio),
          image: "https://audio-uploadss.blr1.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.ru.image),
          video: "https://audio-uploadss.blr1.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.ru.video),
        ...
        uz: {
          ...
          smallaudio: "https://audio-uploadss.blr1.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.uz.smallaudio),
          image: "https://audio-uploadss.blr1.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.uz.image),
          video: "https://audio-uploadss.blr1.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.uz.video),
