    ...
    const audioWithUrls = audioEntries.map(entry => {
      ...
      const mapAudioData = (audios) => {
        return audios.map(item => {
          return {
            id: item.id,
            title: item.title,
            audio: "https://audio-upload.nyc3.digitaloceanspaces.com/audio-uploads/" + extractFileName(item.audio),
      ...
      return {
        ...
        ru: {
          ...
          smallaudio: "https://audio-upload.nyc3.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.ru.smallaudio),
          image: "https://audio-upload.nyc3.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.ru.image),
          video: "https://audio-upload.nyc3.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.ru.video),
        ...
        uz: {
          ...
          smallaudio: "https://audio-upload.nyc3.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.uz.smallaudio),
          image: "https://audio-upload.nyc3.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.uz.image),
          video: "https://audio-upload.nyc3.digitaloceanspaces.com/audio-uploads/" + extractFileName(entry.uz.video),
